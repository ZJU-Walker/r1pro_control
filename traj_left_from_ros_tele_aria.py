...
class TrajFollow:
    def __init__(self, test_mode=False):
        ...
        # self.q_cam_to_base = np.array([0.56243872, -0.55598534, 0.444631075, -0.42055235])
    ...
    def run(self):
        ...
        if self.test_mode == 'print':
            ...
            filepath = '/home/nvidia/ke/r1_pro_sdk_118/install/share/mobiman/scripts/left/left.csv'
            if not os.path.exists(filepath):
                rospy.logerr(f"Trajectory file not found: {filepath}")
                return
...
if __name__ == '__main__':
    try:
        ...
        test_mode = False  # Change this to False, 'print', 'ori', 'translation', 'move_step', 'translation_smooth', 'ros_tele', or 'ros_hand_test'
