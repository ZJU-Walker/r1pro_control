...
class CsvStepController(Node):
    ...
    def load_trajectory_from_csv(self):
        ...
        POS_X_KEY = f'{self.arm}_pos_x'
        POS_Y_KEY = f'{self.arm}_pos_y'
        POS_Z_KEY = f'{self.arm}_pos_z'
        ORI_X_KEY = f'{self.arm}_ori_x'
        ORI_Y_KEY = f'{self.arm}_ori_y'
        ORI_Z_KEY = f'{self.arm}_ori_z'
        ORI_W_KEY = f'{self.arm}_ori_w'
...
def main(args=None):
    ...
    csv_file = '/home/irislab/r1pro_control/robot_control_ros2/replay_files/ee_hand.csv'
