...
class TrajFollow:
    ...
    def run(self):
        ...
        if self.test_mode == 'print':
            ...
            filepath = '/home/nvidia/ke/r1_pro_sdk/install/share/mobiman/script/leds_left_hand_translate.csv'
            ...
            filepath = '/home/nvidia/ke/r1_pro_sdk/install/share/mobiman/script/left/robot_co.csv'
            if not os.path.exists(filepath):
                rospy.logerr(f"Trajectory file not found: {filepath}")
                return
